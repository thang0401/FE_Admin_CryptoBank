...
const data: DataType = {
  ...
  profile: {
    ...
    teams: [
      { property: 'Backend Developer', value: '(126 Members)', icon: 'bxl:github', color: 'primary' },
      { property: 'React Developer', value: '(98 Members)', icon: 'bxl:react', color: 'info' }
    ],
    overview: [
      { property: 'Task Compiled', value: '13.5k', icon: 'bx:check' },
      { property: 'Connections', value: '897', icon: 'bx:user' },
      { property: 'Projects Compiled', value: '146', icon: 'bx:customize' }
    ],
    connections: [
      {
        isFriend: false,
