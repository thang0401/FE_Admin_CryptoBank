          ...
          <Grid container sx={{ p: { sm: 4, xs: 0 } }}>
            <Grid item sm={6} xs={12}>
              <Box sx={{ display: 'flex', flexDirection: 'column', mb: { sm: 0, xs: 6 } }}>
                ...
                <Typography variant='h5'>Transfer Successfully</Typography>
                {/* <div>
              ...
              <Box sx={{ display: 'flex', justifyContent: { xs: 'flex-start', sm: 'flex-end' } }}>
                <Table sx={{ maxWidth: '200px' }}>
                  <TableBody>
                    <TableRow>
                      <MUITableCell>
                        <Typography variant='h5'> TransferID</Typography>
                      </MUITableCell>
                      <MUITableCell>
        ...
        <CardContent>
          <Grid container sx={{ p: { sm: 4, xs: 0 }, pb: theme => `${theme.spacing(1)} !important` }}>
            <Grid item xs={12} sm={6} sx={{ mb: { lg: 0, xs: 5 } }}>
              <Typography sx={{ mb: 4, fontWeight: 500 }}>Send From:</Typography>
            ...
            >
              <div>
                <Typography sx={{ mb: 4, color: 'text.secondary', fontWeight: 500 }}>Transfer To:</Typography>
                <TableContainer>
                  <Table>
                    <TableBody>
                      <TableRow>
