...
const assetsType: string[] = ['Solana', 'Ethereum', 'bitcoin', 'SFC-VND', 'SPLSC']
    ...
    >
      ...
      <Box sx={{ p: 6, pt: 8 }}>
        <FormControl fullWidth sx={{ mb: 6 }}>
          <TextField type='email' label='From Portfolio Name' variant='outlined' />
        </FormControl>
        <FormControl fullWidth sx={{ mb: 6 }}>
          <TextField type='email' label='To Received Public key' variant='outlined' />
        </FormControl>
        <FormControl fullWidth sx={{ mb: 6 }}>
          <Autocomplete
            options={assetsType}
