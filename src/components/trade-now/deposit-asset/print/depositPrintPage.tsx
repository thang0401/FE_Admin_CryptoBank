      ...
      <Box sx={{ p: 12, pb: 6 }}>
        ...
        <Grid container>
          <Grid item xs={7} md={8} sx={{ mb: { lg: 0, xs: 4 } }}>
            <div>
              <Typography sx={{ mb: 4, color: 'text.secondary', fontWeight: 500 }}>Deposit To:</Typography>
              <TableContainer>
                <Table>
                  <TableBody>
                    <TableRow>
          ...
          <Grid item xs={5} md={4}>
            <Typography sx={{ mb: 3.5, fontWeight: 600, color: 'text.secondary' }}>Deposit To:</Typography>
            <div>
              <TableContainer>
                <Table>
                  <TableBody>
