...
const data: { [key: string]: DataType } = {
  transfer: {
    ...
    series: [{ name: 'Transfer', data: [24, 21, 30, 22, 42, 26, 35, 29] }]
  },
  savings: {
    difference: 16,
    stats: '$316.5k',
    ...
    series: [{ name: 'Savings', data: [24, 21, 10, 22, 42, 76, 35, 29] }]
  },
  p2p: {
    difference: 28,
    title: 'P2P',
    ...
    series: [{ name: 'P2P', data: [24, 21, 30, 12, 42, 26, 15, 29] }]
  }
}
...
const AmountOfTransaction = () => {
  // ** State
  const [value, setValue] = useState<string>('transfer')
    ...
    <Card>
      ...
      <TabContext  value={value}>
        ...
        <TabPanel value={value} sx={{ border: 0, boxShadow: 0, p: '0 !important', backgroundColor: 'transparent' }}>
          ...
          <ReactApexcharts type='area' width={500}  height={222} options={options} series={series} />
