...
const ProfitFromTransactionFee = () => {
  // ** Hook
    ...
    <Card>
      <Grid container>
        <StyledGrid item xs={12} md={8}>
          <CardHeader
            sx={{ p: 5, pb: 0 }}
            title='Doanh thu từ phí giao dịch'
            subheader='Yearly report overview'
            subheaderTypographyProps={{ sx: { fontSize: '1rem !important', color: 'text.disabled' } }}
          />
          <ReactApexcharts type='area' width={500} height={315} options={options} series={series} />
        </StyledGrid>
...
export default ProfitFromTransactionFee
