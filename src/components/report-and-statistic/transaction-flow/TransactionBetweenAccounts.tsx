...
const TransactionBetweenAccounts = () => {
  // ** Hook
  ...
  return (
    <Card>
      <CardContent sx={{ p: `${theme.spacing(4, 5)} !important` }}>
        <Grid container>
          <StyledGrid item xs={24} sm={12}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
              <Typography variant='h6'>Tổng khối lượng chuyển khoản nội bộ</Typography>
              <Typography variant='body2'>Theo Khung tuần</Typography>
            </Box>
...
export default TransactionBetweenAccounts
